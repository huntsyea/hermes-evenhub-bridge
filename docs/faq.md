...
| Companion app can't connect | Wrong URL or token. Re-run `hermes even-g2 setup` or check the dashboard **App URL**; confirm the app uses the same token shown/generated by setup. |
